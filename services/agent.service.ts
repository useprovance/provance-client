...
export const AGENTS: Agent[] = [
   ...
   },
   {
      ...
      nodeType: "agent",
      label: "Gruff",
      description: "Executes token swaps and balance checks on GOAT Network (Bitcoin L2) via OKU — a Uniswap V3 compatible DEX.",
      author: "Provance",
      downloads: "1.2K",
      rating: 4.7,
      ...
      config: [
         {
            ...
            label: "Parameters",
            fields: [
               { key: "action", label: "Action", type: "select", options: ["balance", "swap"] },
               { key: "token_in", label: "Token In (address or symbol)", type: "text", placeholder: "WGBTC" },
               { key: "token_out", label: "Token Out (address or symbol)", type: "text", placeholder: "GOAT" },
               { key: "amount_in", label: "Amount In", type: "text", placeholder: "0.001" },
               { key: "slippage_bps", label: "Slippage (basis points)", type: "number", placeholder: "50" },
               { key: "fee_tier", label: "Pool Fee Tier", type: "select", options: ["500", "3000", "10000"] },
            ],
         },
         SETTINGS_CONFIG,
      ],
