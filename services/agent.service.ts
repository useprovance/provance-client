...
export const AGENTS: Agent[] = [
      ...
      actions: [
         {
            ...
            description: "Scan newly listed tokens filtered by liquidity, age, and volume.",
            config: [
               {
                  key: "parameters",
                  label: "Parameters",
      ...
      actions: [
         {
            key: "security_scan",
            label: "Security Scan",
            description: "Run on-chain security checks on a token contract and flag risks.",
            config: [
               {
                  key: "parameters",
                  label: "Parameters",
      ...
      actions: [
         {
            ...
            description: "Simulate a buy and sell to confirm the token can actually be sold.",
            config: [
               {
                  key: "parameters",
                  label: "Parameters",
   ...
   },
   {
      ...
      nodeType: "agent",
      label: "OpenAI",
      description: "Runs a prompt through OpenAI's GPT models and returns the response. Connect to any node to add AI reasoning to your workflow.",
      author: "Provance",
      downloads: "5.2K",
      rating: 5,
      ...
      actions: [
         {
            key: "run_prompt",
            label: "Run Prompt",
            description: "Send a prompt to a GPT model and get a response back.",
            config: [
               {
                  key: "parameters",
                  label: "Parameters",
      ...
      actions: [
         {
            key: "send_message",
            label: "Send Message",
            description: "Send a formatted message to a Telegram channel or group.",
            config: [
               {
                  key: "parameters",
                  label: "Parameters",
      ...
      actions: [
         {
            key: "execute_trade",
            label: "Execute Trade",
            description: "Check balances, get a quote, and execute a swap on GOAT Network via OKU.",
            config: [
               {
                  key: "parameters",
                  label: "Parameters",
      ...
      actions: [
         {
            key: "execute_trade",
            label: "Execute Trade",
            description: "Check balances, read the order book, and execute a swap or limit order on Stellar.",
            config: [
               {
                  key: "parameters",
                  label: "Parameters",
   ...
   },
   {
      ...
      nodeType: "agent",
      label: "CoinGecko",
      description: "Fetches token price, market cap, volume, and metadata from CoinGecko. Use it to enrich workflow data with live market information.",
      author: "Provance",
      downloads: "3.4K",
      rating: 4.8,
      ...
      actions: [
         {
            ...
            description: "Fetch price, market cap, volume, and ATH for a coin by its CoinGecko ID.",
            config: [
               {
                  key: "parameters",
                  label: "Parameters",
                  fields: [
                     { key: "coin_id", label: "CoinGecko coin ID", type: "text", placeholder: "bitcoin" },
                  ],
               },
               SETTINGS_CONFIG,
            ],
         },
         {
            ...
            description: "Look up a token by its contract address on a specific chain.",
            config: [
               {
                  key: "parameters",
                  label: "Parameters",
                  fields: [
                     { key: "token_address", label: "Contract address", type: "text", placeholder: "0x..." },
                     { key: "chain", label: "Chain", type: "select", options: ["ethereum", "base", "bsc", "arbitrum", "polygon"] },
                  ],
               },
               SETTINGS_CONFIG,
            ],
   ...
   },
   {
      ...
      nodeType: "agent",
      label: "GeckoTerminal",
      description: "Scans new liquidity pools across chains in real time using GeckoTerminal. Filters by liquidity, age, and volume to surface newly launched tokens.",
      author: "Provance",
      downloads: "4.7K",
      rating: 4.6,
      ...
      actions: [
         {
            key: "new_pools",
            label: "New Pools",
            description: "Scan newly launched liquidity pools filtered by chain, liquidity, and age.",
            config: [
               {
                  key: "parameters",
                  label: "Parameters",
                  fields: [
                     { key: "chain", label: "Chain", type: "select", options: ["base", "ethereum", "bsc", "arbitrum", "polygon"] },
                     { key: "min_liquidity_usd", label: "Min liquidity (USD)", type: "number", placeholder: "10000" },
                     { key: "max_age_minutes", label: "Max age (minutes)", type: "number", placeholder: "2880" },
         ...
         },
         {
            key: "token_info",
            label: "Token Info",
            description: "Get price, FDV, market cap, and top pools for a token by contract address.",
            config: [
               {
                  key: "parameters",
                  label: "Parameters",
         ...
         },
         {
            key: "ohlcv",
            label: "OHLCV",
            description: "Fetch candlestick chart data for a pool over a given timeframe.",
            config: [
               {
                  key: "parameters",
                  label: "Parameters",
                  fields: [
                     { key: "pool_address", label: "Pool address", type: "text", placeholder: "0x..." },
                     { key: "chain", label: "Chain", type: "select", options: ["base", "ethereum", "bsc", "arbitrum", "polygon"] },
                     { key: "timeframe", label: "Timeframe", type: "select", options: ["minute", "hour", "day"] },
                     { key: "aggregate", label: "Candle size", type: "number", placeholder: "1" },
                  ],
               },
               SETTINGS_CONFIG,
            ],
         },
         {
            key: "trades",
            label: "Recent Trades",
            description: "Fetch the latest trades in a pool over the last 24 hours.",
            config: [
               {
                  key: "parameters",
                  label: "Parameters",
         ...
         },
         {
            ...
            description: "Get the top trending pools on a chain by volume or transaction count.",
            config: [
               {
                  key: "parameters",
                  label: "Parameters",
                  fields: [
                     { key: "chain", label: "Chain", type: "select", options: ["base", "ethereum", "bsc", "arbitrum", "polygon"] },
                     { key: "order", label: "Sort by", type: "select", options: ["h24_volume_usd_desc", "h24_tx_count_desc"] },
                     { key: "limit", label: "Max results", type: "number", placeholder: "10" },
                  ],
               },
               SETTINGS_CONFIG,
